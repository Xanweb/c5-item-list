...
var ItemList = /*#__PURE__*/function () {
  ...
  _createClass(ItemList, [{
    ...
    value: function initFileSelectors($item) {
      var my = this;
      var fileSelector = ".".concat(my.options.classes.file_selector);
      $item.find(fileSelector).each(function () {
        var componentScript = "<script type=\"text/javascript\">\n                $(function() {\n                    Concrete.Vue.activateContext('cms', function (Vue, config) {\n                        new Vue({\n                            el: 'div[data-concrete-file-input=\"".concat($(this).data('concrete-file-input'), "\"]',\n                            components: config.components\n                        })\n                    })\n                })\n            </script>");
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\xw_website\public\vendor\xanweb\c5-item-list\build\assets\js\slider\index.js */"./assets/js/slider/index.js");
